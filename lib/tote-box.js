...
cache.large = {
  ...
  set: function set(primaryKey, secondary, data) {
    ...
    if (secondaryData && util_type(secondaryData) === util_type(data) && Object(external_root_Lodash_amd_lodash_commonjs_lodash_commonjs2_lodash_["isPlainObject"])(data)) {
...
/* harmony default export */ var src_cache = (cache);
...
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "cache", function() { return src_cache; });
